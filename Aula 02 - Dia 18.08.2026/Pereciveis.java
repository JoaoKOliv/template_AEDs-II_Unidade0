...
public class Pereciveis extends Produto{
    ...
    public Pereciveis(String desc, double precoCusto, double margemLucro, LocalDate validade){
	...
	public Pereciveis(String desc, double precoCusto, LocalDate validade) {
